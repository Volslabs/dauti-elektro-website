...
function PrivacyContent() {
  return <>
    ...
    <p>Diese Website wird bei der IONOS SE gehostet. Beim Aufruf verarbeitet der Hosting-Anbieter technisch erforderliche Zugriffsdaten, insbesondere die angeforderte Seite oder Datei, Referrer, Browsertyp und Browserversion, Betriebssystem, Gerätetyp sowie den Zeitpunkt des Zugriffs. Nach Angaben von IONOS werden dabei erhobene Besucherdaten direkt anonymisiert. Die Verarbeitung dient der sicheren und stabilen Bereitstellung der Website auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.</p>
    <p>Hosting-Anbieter ist die IONOS SE, Elgendorfer Straße 57, 56410 Montabaur, Deutschland. Weitere Informationen enthält die <a href="https://www.ionos.de/hilfe/datenschutz/datenverarbeitung-durch-ihr-ionos-produktes/datenverarbeitung-durch-webhosting-produkte/" target="_blank" rel="noreferrer">Information zur Datenverarbeitung durch IONOS Webhosting</a>.</p>
